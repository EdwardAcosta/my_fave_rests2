...
@teams = []
def menu
    puts "Welcome to the Tournament Generator. Enter the number of your selections"
    puts "1. Enter Teams"
    puts "2. List Teams"
...
def enter_teams
        # puts "Enter team names and their seed. When finished type "done" instead of team name"    
    name = " "
        while name != "done"
            print "School name: "
